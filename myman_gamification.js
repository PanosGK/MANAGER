...
const SHOP_CONSUMABLE_CATALOG = [
    ...
    { id: 'medicine', name: 'Vet Kit', icon: '🩺', cost: 40, type: 'consumable', group: 'mascot', mascotOnly: true,
      desc: 'Weekly vet checkup — cure + heal (1×/week).', effect: { careAction: 'medicine', mascotState: 'happy', mascotMs: 2000 } },
