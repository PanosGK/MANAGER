...
(function() {
    ...
    function addGlobalStyles() {
        GM_addStyle(`
            ...
            .tm-notification-header h4 { margin: 0; font-size: 16px; flex: 1; min-width: 0; }
            .tm-notification-header-actions { display: flex; align-items: center; gap: 8px; flex-shrink: 0; }
            ...
            #tm-notification-panel-close { font-size: 22px !important; line-height: 1; text-decoration: none !important; opacity: 0.85; }
            #tm-notification-list { flex-grow: 1; overflow-y: auto; padding: 8px; }
            .tm-notification-item { display: flex; gap: 10px; padding: 10px; border-bottom: 1px solid #f5f5f5; cursor: pointer; }
            ...
            .tm-modal-content {
                background: var(--tm-dark-color); padding: 25px; border-radius: 8px;
            ...
            .tm-level-up-content::-webkit-scrollbar-thumb {
                background: rgba(var(--tm-primary-color-rgb, 255,255,255), 0.4);
                border-radius: 4px;
            }
            .tm-level-up-content::-webkit-scrollbar-thumb:hover {
                background: rgba(var(--tm-primary-color-rgb, 255,255,255), 0.6);
            }
