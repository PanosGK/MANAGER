...
(function() {
    ...
    // ===================================================================
    function tmAddStyleChunks(css, maxChunk) {
        const limit = Math.max(24000, maxChunk || 90000);
        if (!css || typeof GM_addStyle !== 'function') return;
        if (css.length <= limit) {
            GM_addStyle(css);
            return;
        }
        ...
        for (let i = 0; i < css.length; i++) {
            ...
            if (c === '{') depth++;
                ...
                if (depth === 0) {
                    lastSafe = i + 1;
                    if (lastSafe - start >= limit) {
                        chunks.push(css.slice(start, lastSafe));
                        start = lastSafe;
                    }
                }
            }
        ...
        chunks.forEach((chunk) => {
            if (chunk && chunk.trim()) GM_addStyle(chunk);
        });
    }
    ...
    function addGlobalStyles() {
        ...
        const css = `
            ...
            #tm-mascot-container.mascot-char-crystal:not(.mascot-happy):not(.mascot-sad):not(.mascot-energized)::before {
                background:
                    radial-gradient(circle, rgba(77,208,225,0.4) 0%, rgba(118,255,3,0.15) 45%, transparent 70%);
                box-shadow: 0 0 24px rgba(77,208,225,0.5), 0 0 48px rgba(0,150,136,0.25);
                opacity: 1;
                animation: tm-legendary-aura-pulse 2.6s ease-in-out infinite;
                will-change: opacity, transform;
            }
            ...
            #tm-mascot-container.mascot-char-aether.tm-aether-glow-on:not(.mascot-happy):not(.mascot-sad):not(.mascot-energized)::before {
                opacity: 0.9;
                animation: tm-mythic-aura-pulse 5.5s ease-in-out infinite;
            }
            /* Secondary bloom — soft fade only (no hard ring / spin). Skip parked so 📌 pin wins ::after. */
            #tm-mascot-container.mascot-char-aether:not(.mascot-parked)::after {
                content: '';
                position: absolute;
                top: 50%; left: 50%;
                ...
                background: radial-gradient(circle,
                    ...
                    rgba(77,208,225,0.08) 35%,
                    rgba(124,77,255,0.05) 55%,
                    transparent 72%);
                box-shadow: none;
                z-index: -1;
                pointer-events: none;
            ...
            #tm-mascot-container.mascot-char-aether.tm-aether-ring-on:not(.mascot-parked)::after {
                opacity: 0.75;
                animation: tm-mythic-aura-pulse 7s ease-in-out infinite;
            }
            .tm-mascot-robot.mascot-char-phoenix {
                filter: drop-shadow(0 0 6px rgba(255,109,0,0.75)) drop-shadow(0 0 14px rgba(255,234,0,0.4));
            }
            ...
            .tm-mascot-robot.mascot-char-aether {
                filter:
                    drop-shadow(0 6px 12px rgba(18,0,31,0.2))
                    drop-shadow(0 0 16px rgba(77,208,225,0.16));
            }
            ...
            #tm-mascot-container:hover .tm-mascot-robot.mascot-char-crystal {
            ...
            #tm-mascot-container:hover .tm-mascot-robot.mascot-char-aether {
                filter: brightness(1.04)
                    drop-shadow(0 6px 14px rgba(18,0,31,0.32))
            ...
            /* Fallen angel: root → mid → tip cascade (must beat sovereign/parked overrides) */
            ...
            #tm-mascot-container.mascot-char-aether .tm-animate-wing-left .tm-aether-wing-root,
            #tm-mascot-container.mascot-char-aether .tm-animate-wing-right .tm-aether-wing-root,
            #tm-mascot-container .mascot-char-aether .tm-animate-wing-left .tm-aether-wing-root,
            #tm-mascot-container .mascot-char-aether .tm-animate-wing-right .tm-aether-wing-root {
                animation: tm-aether-seg-root 3.6s cubic-bezier(0.55, 0.05, 0.35, 1) infinite !important;
            }
            #tm-mascot-container.mascot-char-aether .tm-animate-wing-left .tm-aether-wing-mid,
            #tm-mascot-container.mascot-char-aether .tm-animate-wing-right .tm-aether-wing-mid,
            #tm-mascot-container .mascot-char-aether .tm-animate-wing-left .tm-aether-wing-mid,
            #tm-mascot-container .mascot-char-aether .tm-animate-wing-right .tm-aether-wing-mid {
                animation: tm-aether-seg-mid 3.6s cubic-bezier(0.55, 0.05, 0.35, 1) infinite !important;
                animation-delay: 0.1s !important;
            }
            #tm-mascot-container.mascot-char-aether .tm-animate-wing-left .tm-aether-wing-tip,
            #tm-mascot-container.mascot-char-aether .tm-animate-wing-right .tm-aether-wing-tip,
            #tm-mascot-container .mascot-char-aether .tm-animate-wing-left .tm-aether-wing-tip,
            #tm-mascot-container .mascot-char-aether .tm-animate-wing-right .tm-aether-wing-tip {
                animation: tm-aether-seg-tip 3.6s cubic-bezier(0.45, 0.02, 0.3, 1) infinite !important;
            ...
            #tm-mascot-container.mascot-moving:not(.mascot-parked) .mascot-char-aether .tm-animate-wing-left .tm-aether-wing-root,
            #tm-mascot-container.mascot-moving:not(.mascot-parked) .mascot-char-aether .tm-animate-wing-right .tm-aether-wing-root {
                animation: tm-aether-seg-root 0.55s ease-in-out infinite !important;
            }
            ...
            #tm-mascot-container.mascot-moving:not(.mascot-parked) .mascot-char-aether .tm-animate-wing-left .tm-aether-wing-mid,
            #tm-mascot-container.mascot-moving:not(.mascot-parked) .mascot-char-aether .tm-animate-wing-right .tm-aether-wing-mid {
                animation: tm-aether-seg-mid 0.55s ease-in-out infinite !important;
            ...
            #tm-mascot-container.mascot-moving:not(.mascot-parked) .mascot-char-aether .tm-animate-wing-left .tm-aether-wing-tip,
            #tm-mascot-container.mascot-moving:not(.mascot-parked) .mascot-char-aether .tm-animate-wing-right .tm-aether-wing-tip {
                animation: tm-aether-seg-tip 0.55s ease-in-out infinite !important;
                animation-delay: 0.1s !important;
            }
            ...
            #tm-mascot-container.mascot-char-aether .tm-aether-wing-tatter:nth-child(odd),
            #tm-mascot-container .mascot-char-aether .tm-aether-wing-tatter:nth-child(odd) {
            ...
            #tm-mascot-container.mascot-idle:not(.mascot-parked):not(.mascot-focus-quiet) .mascot-char-aether .tm-aether-wing-vein {
                animation: tm-aether-vein-pulse 5.2s ease-in-out infinite;
            }
            #tm-mascot-container.mascot-idle:not(.mascot-parked):not(.mascot-focus-quiet) .mascot-char-aether .tm-aether-wing-crack {
                animation: tm-aether-crack-pulse 6.4s ease-in-out infinite;
            }
            #tm-mascot-container.mascot-idle:not(.mascot-parked):not(.mascot-focus-quiet) .mascot-char-aether .tm-aether-wing-claw {
            ...
            #tm-mascot-container.tm-aether-react .tm-aether-wing-vein {
                animation: tm-aether-vein-pulse 1.1s ease-in-out infinite;
            }
            ...
            /* Random FX layers — soft godsend blooms (blur + fade, no harsh lines) */
            ...
            .mascot-char-aether .tm-aether-halo,
            .mascot-char-aether .tm-aether-core-ring,
            .mascot-char-aether .tm-aether-rune-tattoos {
                filter: none;
            }

            /* ── Aether lite / ultra: old-PC friendly (auto-applied by JS) ── */
            #tm-mascot-container.tm-aether-lite.mascot-char-aether::before,
            #tm-mascot-container.tm-aether-lite.mascot-char-aether::after {
                filter: none !important;
                box-shadow: none !important;
                animation: none !important;
            ...
            #tm-mascot-container.tm-aether-lite.mascot-char-aether.tm-aether-glow-on::before {
                opacity: 0.55 !important;
                background: radial-gradient(circle, rgba(77,208,225,0.22) 0%, transparent 70%) !important;
            }
            #tm-mascot-container.tm-aether-lite.mascot-char-aether.tm-aether-ring-on::after {
                opacity: 0 !important;
            }
            #tm-mascot-container.tm-aether-lite .tm-mascot-robot.mascot-char-aether,
            #tm-mascot-container.tm-aether-lite:hover .tm-mascot-robot.mascot-char-aether,
            #tm-mascot-container.tm-aether-lite .tm-mascot-robot.mascot-char-aether.mascot-middleage,
            #tm-mascot-container.tm-aether-lite .tm-mascot-robot.mascot-char-aether.mascot-old {
                filter: drop-shadow(0 4px 8px rgba(18,0,31,0.28)) !important;
            }
            #tm-mascot-container.tm-aether-lite .tm-aether-fx {
                filter: none !important;
                transition: opacity 0.35s ease !important;
            }
            #tm-mascot-container.tm-aether-lite .tm-aether-fx:not([data-fx="corona"]):not([data-fx="aura"]):not([data-fx="sparks"]) {
                display: none !important;
            }
            #tm-mascot-container.tm-aether-lite .tm-aether-fx[data-fx="sparks"] {
                display: none !important;
            }
            #tm-mascot-container.tm-aether-lite .tm-aether-wing-vein,
            #tm-mascot-container.tm-aether-lite .tm-aether-wing-crack,
            #tm-mascot-container.tm-aether-lite .tm-aether-wing-claw,
            #tm-mascot-container.tm-aether-lite .tm-aether-wing-star,
            #tm-mascot-container.tm-aether-lite .tm-aether-core,
            #tm-mascot-container.tm-aether-lite .tm-aether-core-ring,
            #tm-mascot-container.tm-aether-lite .tm-aether-halo,
            #tm-mascot-container.tm-aether-lite .tm-aether-veins,
            #tm-mascot-container.tm-aether-lite .tm-aether-eclipse,
            #tm-mascot-container.tm-aether-lite .tm-aether-moonshard-orbit,
            #tm-mascot-container.tm-aether-lite .tm-aether-charge-ring,
            #tm-mascot-container.tm-aether-lite .tm-aether-form-crest,
            #tm-mascot-container.tm-aether-lite .tm-aether-world-dim-local,
            #tm-mascot-container.tm-aether-lite .tm-aether-myth-particle.is-star,
            #tm-mascot-container.tm-aether-lite .tm-aether-myth-particle.is-shard {
                animation: none !important;
            }
            #tm-mascot-container.tm-aether-lite .tm-aether-moonshard-orbit,
            #tm-mascot-container.tm-aether-lite .tm-aether-charge-ring,
            #tm-mascot-container.tm-aether-lite .tm-aether-world-dim-local,
            #tm-mascot-container.tm-aether-lite .tm-aether-mythic-weather-local {
                display: none !important;
            }
            ...
            #tm-mascot-container.tm-aether-lite .tm-aether-fx.tm-fx-on .tm-aether-corona,
            #tm-mascot-container.tm-aether-lite .tm-aether-fx.tm-fx-on .tm-aether-aura-outer,
            #tm-mascot-container.tm-aether-lite .tm-aether-fx.tm-fx-on.tm-aether-beams,
            #tm-mascot-container.tm-aether-lite .tm-aether-fx.tm-fx-on .tm-aether-sigil,
            #tm-mascot-container.tm-aether-lite .tm-aether-fx.tm-fx-on.tm-aether-runes,
            #tm-mascot-container.tm-aether-lite .tm-aether-fx.tm-fx-on .tm-aether-shard,
            #tm-mascot-container.tm-aether-lite .tm-aether-fx.tm-fx-on .tm-aether-ribbon {
                animation: none !important;
            }

            /* Ultra: sprite + slow float only */
            #tm-mascot-container.tm-aether-ultra.mascot-char-aether::before,
            #tm-mascot-container.tm-aether-ultra.mascot-char-aether::after,
            #tm-mascot-container.tm-aether-ultra .tm-aether-fx {
                display: none !important;
            }
            #tm-mascot-container.tm-aether-ultra .tm-mascot-robot.mascot-char-aether {
                filter: none !important;
            }
            #tm-mascot-container.tm-aether-ultra.mascot-idle .tm-mascot-robot.mascot-char-aether {
                animation: tm-mythic-idle-float 7s ease-in-out infinite !important;
            }
            #tm-mascot-container.tm-aether-ultra .tm-animate-wing-left,
            #tm-mascot-container.tm-aether-ultra .tm-animate-wing-right,
            #tm-mascot-container.tm-aether-ultra .tm-animate-tail {
                animation: none !important;
            }

            @media (prefers-reduced-motion: reduce) {
                #tm-mascot-container.mascot-char-aether::before,
                #tm-mascot-container.mascot-char-aether::after,
                #tm-mascot-container.mascot-char-aether .tm-aether-fx,
                #tm-mascot-container.mascot-char-aether .tm-aether-wing-vein,
                #tm-mascot-container.mascot-char-aether .tm-aether-wing-crack,
                #tm-mascot-container.mascot-char-aether .tm-aether-wing-claw,
                #tm-mascot-container.mascot-char-aether .tm-aether-wing-star {
                    animation: none !important;
                    filter: none !important;
                }
                #tm-mascot-container.mascot-idle .tm-mascot-robot.mascot-char-aether {
            ...
            /* Pause continuous Aether paint when tab hidden or focus quiet */
            #tm-mascot-container.mascot-focus-quiet.mascot-char-aether .tm-animate-wing-left,
            #tm-mascot-container.mascot-focus-quiet.mascot-char-aether .tm-animate-wing-right,
            #tm-mascot-container.mascot-focus-quiet.mascot-char-aether .tm-aether-wing-seg,
            #tm-mascot-container.mascot-focus-quiet.mascot-char-aether .tm-aether-wing-tatter,
            #tm-mascot-container.mascot-focus-quiet.mascot-char-aether .tm-animate-tail,
            #tm-mascot-container.mascot-focus-quiet .tm-mascot-robot.mascot-char-aether,
            #tm-mascot-container.mascot-focus-quiet .tm-aether-fx,
            #tm-mascot-container.mascot-focus-quiet .tm-aether-wing-vein,
            #tm-mascot-container.mascot-focus-quiet .tm-aether-wing-crack,
            #tm-mascot-container.mascot-focus-quiet .tm-aether-wing-claw,
            #tm-mascot-container.mascot-focus-quiet .tm-aether-wing-star,
            body.tm-aether-tab-hidden #tm-mascot-container.mascot-char-aether .tm-animate-wing-left,
            body.tm-aether-tab-hidden #tm-mascot-container.mascot-char-aether .tm-animate-wing-right,
            body.tm-aether-tab-hidden #tm-mascot-container.mascot-char-aether .tm-aether-wing-seg,
            body.tm-aether-tab-hidden #tm-mascot-container.mascot-char-aether .tm-aether-wing-tatter,
            body.tm-aether-tab-hidden #tm-mascot-container.mascot-char-aether .tm-animate-tail,
            body.tm-aether-tab-hidden #tm-mascot-container .tm-mascot-robot.mascot-char-aether,
            body.tm-aether-tab-hidden #tm-mascot-container .tm-aether-fx,
            body.tm-aether-tab-hidden #tm-mascot-container .tm-aether-wing-vein,
            body.tm-aether-tab-hidden #tm-mascot-container .tm-aether-wing-crack,
            body.tm-aether-tab-hidden #tm-mascot-container .tm-aether-wing-claw,
            body.tm-aether-tab-hidden #tm-mascot-container .tm-aether-wing-star,
            body.tm-aether-tab-hidden #tm-aether-screen-aura .tm-aether-screen-bloom,
            body.tm-aether-tab-hidden #tm-aether-screen-aura .tm-aether-screen-ring,
            body.tm-aether-tab-hidden #tm-aether-screen-aura .tm-aether-screen-haze,
            body.tm-aether-tab-hidden #tm-aether-screen-aura .tm-aether-screen-rays {
                animation: none !important;
            }
            body.tm-aether-tab-hidden #tm-aether-screen-aura,
            body.tm-aether-tab-hidden #tm-aether-world-dim {
                transition: none !important;
            }
            ...
            #tm-mascot-container.mascot-idle .mascot-char-aether .tm-aether-fx.tm-fx-on.tm-aether-beams {
                animation: tm-mythic-beam-pulse 5.5s ease-in-out infinite;
                transform-origin: 50px 50px;
            }
            #tm-mascot-container.mascot-idle .mascot-char-aether .tm-aether-fx.tm-fx-on .tm-aether-sigil {
                animation: tm-mythic-sigil-pulse 6s ease-in-out infinite;
            ...
            #tm-mascot-container.mascot-idle .mascot-char-aether .tm-aether-fx.tm-fx-on .tm-aether-shard {
                animation: tm-mythic-shard-drift 5.5s ease-in-out infinite;
            }
            ...
            #tm-mascot-container.mascot-idle .mascot-char-aether .tm-aether-eclipse {
                animation: tm-mythic-halo-glow 8s ease-in-out infinite;
                filter: blur(1.2px);
            }
            ...
            #tm-mascot-container.mascot-happy .tm-mascot-robot.mascot-char-aether {
                filter:
                    drop-shadow(0 0 8px rgba(77,208,225,0.95))
                    drop-shadow(0 0 18px rgba(90,61,154,1))
                    drop-shadow(0 0 32px rgba(201,162,39,0.55));
            }
            ...
            @keyframes tm-mythic-orbit-spin-svg {
                from { transform: rotate(0deg); }
                to { transform: rotate(360deg); }
            }
            @keyframes tm-mythic-orbit-spin-svg-rev {
                from { transform: rotate(0deg); }
                to { transform: rotate(-360deg); }
            }
            @keyframes tm-legendary-idle-float {
            ...
            @keyframes tm-legendary-wing-flap-right {
                0%, 100% { transform: rotate(0deg); }
                50% { transform: rotate(18deg); }
            }
            ...
            @keyframes tm-mythic-wing-flap-move {
                0%, 100% { transform: rotate(8deg) scaleY(0.96); }
            ...
            @keyframes tm-mythic-beam-pulse {
                0%, 100% { opacity: 0.22; transform: scale(1); }
                50% { opacity: 0.55; transform: scale(1.06); }
            }
            @keyframes tm-mythic-sigil-pulse {
                0%, 100% { opacity: 0.35; transform: scaleX(1); }
                50% { opacity: 0.75; transform: scaleX(1.12); }
            }
            @keyframes tm-mythic-shard-drift {
            ...
            /* Sovereign idle — keep mild parent beat; 3-seg cascade owns the motion */
            ...
            #tm-mascot-container.tm-aether-blade-spin .tm-aether-fx[data-fx="orbits"] {
                animation: tm-mythic-corona-breathe 2.4s ease-in-out infinite !important;
                filter: blur(3.5px) !important;
            }
            #tm-mascot-container.tm-aether-awaken::before {
                opacity: 1 !important;
                filter: blur(22px) !important;
                animation: tm-mythic-aura-pulse 3.2s ease-in-out infinite !important;
            }
            #tm-mascot-container.tm-aether-awaken .tm-aether-fx {
                opacity: 0.7 !important;
            }
            /* Local world dim — kept as fallback; primary veil is #tm-aether-world-dim fullscreen */
            .tm-aether-world-dim-local {
                display: none !important;
            }
            /* Fullscreen Aether aura field (pointer-events none — never blocks UI) */
            #tm-aether-screen-aura {
                position: fixed;
                inset: 0;
                z-index: 9980;
            ...
            #tm-aether-screen-aura .tm-aether-screen-veil,
            #tm-aether-screen-aura .tm-aether-screen-bloom,
            #tm-aether-screen-aura .tm-aether-screen-ring,
            #tm-aether-screen-aura .tm-aether-screen-haze,
            #tm-aether-screen-aura .tm-aether-screen-rays {
                position: absolute;
                inset: 0;
                pointer-events: none;
                opacity: 0;
            ...
            #tm-aether-screen-aura .tm-aether-screen-veil {
                background:
                    radial-gradient(ellipse 95% 85% at var(--axp, 50%) var(--ayp, 45%),
                        rgba(var(--ac2, 124,77,255), calc(0.16 * var(--aura-strength, 0.4))) 0%,
                        rgba(18, 0, 31, calc(0.18 * var(--aura-strength, 0.4))) 42%,
                        rgba(5, 2, 12, calc(0.22 * var(--aura-strength, 0.4))) 100%);
                opacity: 1;
            }
            #tm-aether-screen-aura .tm-aether-screen-bloom {
                background:
                    radial-gradient(circle 55vmax at var(--ax, 50%) var(--ay, 45%),
                        rgba(var(--ac1, 38,198,218), calc(0.34 * var(--aura-strength, 0.4))) 0%,
                        rgba(var(--ac2, 124,77,255), calc(0.18 * var(--aura-strength, 0.4))) 32%,
                        rgba(var(--ac3, 255,213,79), calc(0.08 * var(--aura-strength, 0.4))) 52%,
                        transparent 72%);
                opacity: 1;
                animation: tm-aether-screen-bloom-pulse 7s ease-in-out infinite;
            }
            #tm-aether-screen-aura.has-ring .tm-aether-screen-ring {
                background:
                    radial-gradient(circle 38vmax at var(--ax, 50%) var(--ay, 45%),
                        transparent 42%,
                        rgba(var(--ac3, 255,213,79), calc(0.14 * var(--aura-strength, 0.4))) 52%,
                        rgba(var(--ac1, 38,198,218), calc(0.1 * var(--aura-strength, 0.4))) 62%,
                        transparent 74%);
                opacity: 1;
                animation: tm-aether-screen-ring-pulse 9s ease-in-out infinite;
            }
            #tm-aether-screen-aura.has-haze .tm-aether-screen-haze {
                background:
                    linear-gradient(115deg,
                        transparent 10%,
                        rgba(var(--ac1, 38,198,218), calc(0.08 * var(--aura-strength, 0.4))) 35%,
                        transparent 55%),
                    linear-gradient(250deg,
                        transparent 20%,
                        rgba(var(--ac2, 124,77,255), calc(0.07 * var(--aura-strength, 0.4))) 48%,
                        transparent 70%);
                opacity: 1;
                animation: tm-aether-screen-haze-drift 14s ease-in-out infinite;
            }
            #tm-aether-screen-aura.has-rays .tm-aether-screen-rays {
                background:
                    conic-gradient(from 210deg at var(--axp, 50%) var(--ayp, 45%),
                        transparent 0deg,
                        rgba(var(--ac3, 255,213,79), calc(0.07 * var(--aura-strength, 0.4))) 18deg,
                        transparent 36deg,
                        transparent 120deg,
                        rgba(var(--ac1, 38,198,218), calc(0.06 * var(--aura-strength, 0.4))) 145deg,
                        transparent 170deg,
                        transparent 360deg);
                opacity: 0.85;
                animation: tm-aether-screen-rays-spin 48s linear infinite;
            }
            #tm-aether-screen-aura.is-strong .tm-aether-screen-bloom {
                animation-duration: 5.2s;
            }
            #tm-aether-screen-aura.is-awaken .tm-aether-screen-bloom {
                animation-duration: 3.4s;
            }
            #tm-aether-screen-aura.is-awaken .tm-aether-screen-veil {
                background:
                    radial-gradient(ellipse 100% 90% at var(--axp, 50%) var(--ayp, 45%),
                        rgba(var(--ac1, 38,198,218), 0.22) 0%,
                        rgba(var(--ac2, 124,77,255), 0.18) 35%,
                        rgba(8, 0, 18, 0.38) 100%);
            }
            #tm-aether-screen-aura.is-lite .tm-aether-screen-rays,
            #tm-aether-screen-aura.is-lite .tm-aether-screen-haze {
                display: none !important;
            }
            #tm-aether-screen-aura.is-lite .tm-aether-screen-bloom,
            #tm-aether-screen-aura.is-lite .tm-aether-screen-ring {
                animation: none !important;
            }
            @keyframes tm-aether-screen-bloom-pulse {
                0%, 100% { opacity: 0.82; transform: scale(1); }
                50% { opacity: 1; transform: scale(1.04); }
            }
            @keyframes tm-aether-screen-ring-pulse {
                0%, 100% { opacity: 0.55; transform: scale(0.96); }
                50% { opacity: 0.95; transform: scale(1.05); }
            }
            @keyframes tm-aether-screen-haze-drift {
                0%, 100% { opacity: 0.7; transform: translate3d(0, 0, 0); }
                50% { opacity: 1; transform: translate3d(-1.5%, 1%, 0); }
            }
            @keyframes tm-aether-screen-rays-spin {
                from { transform: rotate(0deg); }
                to { transform: rotate(360deg); }
            }
            ...
            #tm-aether-world-dim {
                ...
                background:
                    radial-gradient(ellipse 90% 80% at var(--axp, 50%) var(--ayp, 45%),
                        rgba(18, 0, 31, 0.08) 0%,
                        rgba(10, 0, 20, 0.22) 55%,
                        rgba(4, 1, 10, 0.34) 100%);
            }
            ...
            #tm-aether-world-dim.is-lite {
                transition: opacity 0.6s ease;
            }
            #tm-aether-gravity-lens,
            #tm-aether-ambient-tint {
                display: none !important;
            }
            ...
            .tm-aether-gaze-beam {
                ...
                border-radius: 50%;
                opacity: 0;
                background: radial-gradient(ellipse at 50% 0%, rgba(232,224,240,0.55), rgba(124,77,255,0.2), transparent 70%);
                box-shadow: none;
                filter: blur(4px);
                animation: tm-aether-gaze-fire 1.6s ease-out forwards;
            }
            .tm-aether-gaze-beam.is-right {
                background: radial-gradient(ellipse at 50% 0%, rgba(255,213,79,0.45), rgba(239,83,80,0.18), transparent 70%);
                box-shadow: none;
            }
            ...
            /* Soft bloom pulse while moving — no hard orbit spins */
            #tm-mascot-container.mascot-moving.mascot-char-aether .tm-aether-fx.tm-fx-on.tm-aether-orbit-group {
                animation: tm-mythic-corona-breathe 6s ease-in-out infinite !important;
            }
            ...
            #tm-mascot-container.mascot-moving.mascot-char-aether .tm-aether-fx.tm-fx-on .tm-aether-orbit:nth-of-type(3) {
                animation: tm-mythic-corona-breathe 7.5s ease-in-out infinite;
            }
            .mascot-char-aether .tm-aether-fx[data-fx="haze"].tm-fx-on .tm-aether-haze-blob {
                animation: tm-aether-haze-shimmer 5.5s cubic-bezier(0.45, 0.05, 0.55, 0.95) infinite;
                filter: blur(2.5px);
            }
            ...
            /* Gravity lens disabled (backdrop-filter was glitching the site) */
            #tm-aether-gravity-lens { display: none !important; }
            ...
            #tm-aether-mythic-weather {
                ...
                opacity: 0;
                background:
                    linear-gradient(115deg, transparent 15%, rgba(77,208,225,0.14) 38%, transparent 58%),
                    linear-gradient(250deg, transparent 22%, rgba(124,77,255,0.12) 50%, transparent 72%),
                    radial-gradient(ellipse 80% 70% at 50% 40%, rgba(255,213,79,0.08), transparent 70%);
                animation: tm-aether-weather-sweep 5s cubic-bezier(0.4, 0, 0.6, 1) forwards;
            }
            #tm-aether-mythic-weather.is-lite {
                background:
                    linear-gradient(115deg, transparent 20%, rgba(77,208,225,0.1) 40%, transparent 60%);
            }
            .tm-aether-mythic-weather-local {
                position: absolute;
                inset: -20%;
                pointer-events: none;
                z-index: 3;
                opacity: 0;
                background:
                    linear-gradient(115deg, transparent 20%, rgba(77,208,225,0.12) 35%, transparent 50%),
                    linear-gradient(250deg, transparent 30%, rgba(124,77,255,0.1) 48%, transparent 65%);
                animation: tm-aether-weather-sweep 5s cubic-bezier(0.4, 0, 0.6, 1) forwards;
            }
            ...
            /* ─── Aether boss pack II: twin / sheen / domain / eclipse / rarity ─── */
            .mascot-char-aether.mascot-old .tm-aether-wing-broken {
                opacity: 0.82;
                filter: saturate(0.85);
            }
            .mascot-char-aether.mascot-old .tm-aether-wing-dominant {
                filter: contrast(1.05);
            }
            .mascot-char-aether .tm-aether-wing-break {
                animation: tm-aether-crack-pulse 2.8s ease-in-out infinite;
            }

            /* Specular star-metal sheen */
            .tm-mascot-robot.mascot-char-aether {
                position: relative;
            }
            #tm-mascot-container.mascot-char-aether .tm-mascot-robot.mascot-char-aether::after {
                content: '';
                position: absolute;
                inset: -6%;
                pointer-events: none;
                ...
                animation: tm-aether-metal-sheen 7.5s cubic-bezier(0.45, 0.05, 0.55, 0.95) infinite;
            }
            @keyframes tm-aether-metal-sheen {
                0%, 12% { transform: translateX(-120%); opacity: 0; }
                18% { opacity: 0.65; }
                42% { transform: translateX(120%); opacity: 0.2; }
                100% { transform: translateX(120%); opacity: 0; }
            }
            #tm-mascot-container.mascot-char-aether .tm-aether-core {
                transform-box: fill-box;
                transform-origin: center;
            }
            #tm-mascot-container.tm-aether-heartbeat .tm-aether-core {
                animation: tm-aether-core-flare 0.9s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            #tm-mascot-container.tm-aether-heartbeat .tm-aether-wing-vein {
                animation: tm-aether-vein-flare 0.9s cubic-bezier(0.4, 0, 0.2, 1) forwards !important;
            }
            #tm-mascot-container.tm-aether-heartbeat .tm-aether-core-ring {
                opacity: 0.95 !important;
                stroke-width: 1.2 !important;
            }
            @keyframes tm-aether-core-flare {
                0% { transform: scale(1); filter: brightness(1); }
                35% { transform: scale(1.35); filter: brightness(1.55); }
                100% { transform: scale(1); filter: brightness(1); }
            }
            @keyframes tm-aether-vein-flare {
                0% { opacity: 0.35; stroke-width: 0.9; }
                40% { opacity: 1; stroke-width: 1.6; }
                100% { opacity: 0.4; stroke-width: 0.9; }
            }

            /* Shadow twin afterimages while moving */
            .tm-aether-shadow-twin {
                position: absolute;
                left: 50%; top: 50%;
                width: 72%; height: 72%;
                margin: -36% 0 0 -36%;
                ...
                pointer-events: none;
                z-index: 1;
                background: radial-gradient(ellipse at 50% 45%, rgba(5,1,12,0.45), rgba(18,0,31,0.18) 55%, transparent 72%);
                filter: blur(1.5px);
                animation: tm-aether-twin-fade 0.38s cubic-bezier(0.4, 0, 0.6, 1) forwards;
            }
            @keyframes tm-aether-twin-fade {
                0% { opacity: 0.55; transform: scale(1); }
                100% { opacity: 0; transform: scale(0.92) translateY(2px); }
            }

            /* Ambient tint disabled — was full-page mix-blend + UI filters */
            #tm-aether-ambient-tint { display: none !important; }
            body.tm-aether-ambient-on #tm-coin-balance,
            body.tm-aether-ambient-on .tm-panel-header,
            body.tm-aether-ambient-on #tm-settings-btn {
                filter: none !important;
            }

            /* Idle micro-threat poses */
            #tm-mascot-container.tm-aether-pose-tilt .tm-mascot-robot.mascot-char-aether {
                animation: tm-aether-pose-tilt 1.4s cubic-bezier(0.45, 0.05, 0.55, 0.95) forwards !important;
            }
            #tm-mascot-container.tm-aether-pose-shift .tm-mascot-robot.mascot-char-aether {
                animation: tm-aether-pose-shift 1.5s cubic-bezier(0.45, 0.05, 0.55, 0.95) forwards !important;
            }
            #tm-mascot-container.tm-aether-pose-flare .tm-animate-wing-left {
                animation: tm-aether-pose-flare-l 1.2s cubic-bezier(0.4, 0, 0.2, 1) forwards !important;
            }
            #tm-mascot-container.tm-aether-pose-flare .tm-animate-wing-right {
                animation: tm-aether-pose-flare-r 1.2s cubic-bezier(0.4, 0, 0.2, 1) forwards !important;
            }
            @keyframes tm-aether-pose-tilt {
                0%, 100% { transform: rotate(0deg) translateY(0); }
                40% { transform: rotate(-4deg) translateY(-2px); }
                70% { transform: rotate(2deg) translateY(-1px); }
            }
            @keyframes tm-aether-pose-shift {
                0%, 100% { transform: translate(0, 0); }
                45% { transform: translate(5px, -3px); }
            }
            @keyframes tm-aether-pose-flare-l {
                0%, 100% { transform: rotate(0deg); }
                40% { transform: rotate(-22deg); }
            }
            @keyframes tm-aether-pose-flare-r {
                0%, 100% { transform: rotate(0deg); }
                40% { transform: rotate(22deg); }
            }

            /* Judgment / kneel — mascot-local only */
            #tm-mascot-container.tm-aether-judgment-local::after {
                content: '';
                position: absolute;
                inset: -8%;
                pointer-events: none;
                z-index: 20;
                background: rgba(5,1,12,0.2);
                border-radius: 50%;
                animation: tm-aether-judgment-flash 0.08s steps(1, end) forwards;
            }
            html.tm-aether-judgment-frame::after { display: none !important; }
            @keyframes tm-aether-judgment-flash {
                0% { opacity: 1; }
                100% { opacity: 0; }
            }
            #tm-mascot-container.tm-aether-kneel-local .tm-mascot-robot.mascot-char-aether {
                transform: translateY(3px);
                transition: transform 0.45s cubic-bezier(0.4, 0, 0.2, 1);
            }
            body.tm-aether-kneel .tm-floating-widget,
            body.tm-aether-kneel #tm-coin-balance,
            body.tm-aether-kneel #tm-settings-btn {
                transform: none !important;
            }

            /* Metal sheen — rare sweep, mostly still */
            #tm-mascot-container.mascot-char-aether .tm-mascot-robot.mascot-char-aether::after {
                animation: tm-aether-metal-sheen 28s cubic-bezier(0.45, 0.05, 0.55, 0.95) infinite;
                animation-delay: 8s;
            }

            /* ─── Pack IV (optimized): nameplate / tear / blade / crest / ledger ─── */
            .tm-aether-world-nameplate {
                position: fixed;
                ...
                padding: 10px 0;
                background: linear-gradient(90deg, transparent, rgba(18,0,31,0.72) 20%, rgba(18,0,31,0.72) 80%, transparent);
                border-top: 1px solid rgba(201,162,39,0.35);
                border-bottom: 1px solid rgba(201,162,39,0.35);
                opacity: 0;
                animation: tm-aether-world-plate 3.2s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            @keyframes tm-aether-world-plate {
            ...
            #tm-mascot-container.tm-aether-eclipse-iris .tm-aether-eclipse-pupil,
            #tm-mascot-container.tm-aether-eclipse-iris .tm-mascot-eye-open circle:nth-of-type(2) {
                opacity: 0.35;
            }
            #tm-mascot-container.tm-aether-eclipse-iris .tm-aether-eclipse-crescent {
                opacity: 1 !important;
            }

            .tm-aether-reality-tear,
            .tm-aether-astral-clone,
            .tm-aether-spectral-blade,
            .tm-aether-finisher-slash,
            .tm-aether-codex-scrap,
            .tm-aether-trail-ink,
            .tm-aether-rarity-ledger,
            .tm-aether-form-crest {
            ...
            .tm-aether-reality-tear {
                ...
                pointer-events: none;
                z-index: 0;
                background: linear-gradient(180deg, transparent, rgba(5,1,12,0.75), transparent);
                clip-path: polygon(40% 0, 70% 8%, 55% 35%, 80% 55%, 45% 78%, 60% 100%, 20% 92%, 35% 60%, 10% 40%, 30% 18%);
                opacity: 0;
                animation: tm-aether-tear 1.1s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            @keyframes tm-aether-tear {
            ...
            .tm-aether-astral-clone {
                ...
                z-index: 2;
                border-radius: 50%;
                background: radial-gradient(ellipse at 50% 45%, rgba(124,77,255,0.22), transparent 70%);
                border: none;
                filter: blur(4px);
                opacity: 0;
                animation: tm-aether-clone-duel 1.4s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            .tm-aether-astral-clone.is-mirror {
                animation-name: tm-aether-clone-duel-mirror;
            }
            @keyframes tm-aether-clone-duel {
                0% { opacity: 0; transform: translateX(-28px) scale(0.9); }
                35% { opacity: 0.8; transform: translateX(-8px) scale(1); }
                55% { opacity: 0.9; transform: translateX(4px); }
                100% { opacity: 0; transform: translateX(18px) scale(0.95); }
            }
            @keyframes tm-aether-clone-duel-mirror {
                0% { opacity: 0; transform: translateX(28px) scale(0.9); }
                35% { opacity: 0.8; transform: translateX(8px) scale(1); }
                55% { opacity: 0.9; transform: translateX(-4px); }
                100% { opacity: 0; transform: translateX(-18px) scale(0.95); }
            ...
            .tm-aether-spectral-blade {
                ...
                pointer-events: none;
                z-index: 5;
                background: radial-gradient(ellipse at 50% 20%, rgba(232,224,240,0.55), rgba(77,208,225,0.2), transparent 70%);
                box-shadow: none;
                border-radius: 50%;
                filter: blur(3px);
                transform-origin: 50% 100%;
                transform: rotate(12deg) scaleY(0);
                animation: tm-aether-blade 2s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            @keyframes tm-aether-blade {
                0% { transform: rotate(18deg) scaleY(0); opacity: 0; }
                25% { transform: rotate(12deg) scaleY(1); opacity: 1; }
                75% { opacity: 0.85; }
                100% { transform: rotate(22deg) scaleY(0.2); opacity: 0; }
            }
            ...
            #tm-mascot-container.tm-aether-counter-glint .tm-mascot-robot.mascot-char-aether {
                filter: brightness(1.25) drop-shadow(0 0 10px rgba(255,255,255,0.45)) !important;
                transition: filter 0.15s ease;
            }
            ...
            .tm-aether-finisher-slash {
                ...
                animation: tm-aether-finisher 0.28s steps(2, end) forwards;
            }
            @keyframes tm-aether-finisher {
                0% { opacity: 0; transform: rotate(-28deg) scaleX(0.2); }
                40% { opacity: 1; transform: rotate(-28deg) scaleX(1); }
                100% { opacity: 0; }
            }
            ...
            .tm-aether-codex-scrap {
                ...
                padding: 3px;
                letter-spacing: 0.04em;
                animation: tm-aether-codex 3.2s cubic-bezier(0.4, 0, 0.6, 1) forwards;
            }
            @keyframes tm-aether-codex {
                0% { opacity: 0; transform: translateY(8px) rotate(-4deg); }
                20% { opacity: 0.85; }
                100% { opacity: 0; transform: translateY(-18px) rotate(6deg); }
            }

            .tm-aether-witness-sigil {
                display: inline-flex;
                align-items: center;
                gap: 6px;
                margin-top: 8px;
                ...
                font-size: 11px;
                color: #c9a227;
                background: rgba(18,0,31,0.35);
            }
            .tm-aether-witness-sigil::before {
                content: '';
                width: 8px; height: 8px;
            ...
            .tm-aether-form-crest {
                ...
                border-radius: 50%;
                transform: none;
                background: radial-gradient(ellipse at 50% 50%, rgba(201,162,39,0.35), transparent 70%);
                box-shadow: 0 0 12px rgba(124,77,255,0.2);
                filter: blur(2px);
            }
            #tm-mascot-container.mascot-char-aether:has(.mascot-old) .tm-aether-form-crest {
                background: radial-gradient(ellipse at 50% 50%, rgba(122,0,0,0.4), transparent 70%);
            }
            #tm-mascot-container.mascot-char-aether:has(.mascot-middleage) .tm-aether-form-crest {
                background: radial-gradient(ellipse at 50% 50%, rgba(198,40,40,0.35), transparent 70%);
            }
            ...
            .tm-aether-trail-ink {
                ...
                animation: tm-aether-ink-fade 0.9s ease forwards;
            }
            @keyframes tm-aether-ink-fade {
                0% { opacity: 0.7; transform: scaleX(0.4) rotate(-12deg); }
                100% { opacity: 0; transform: scaleX(1.2) rotate(8deg); }
            }
            ...
            .tm-aether-rarity-ledger {
                ...
                background: rgba(18,0,31,0.65);
                padding: 3px 8px;
                border: 1px solid rgba(201,162,39,0.35);
                opacity: 0;
                animation: tm-aether-ledger 2.4s ease forwards;
            }
            @keyframes tm-aether-ledger {
            ...
            .tm-aether-domain-circle {
                ...
                border-radius: 50%;
                border: none;
                background: radial-gradient(ellipse at 50% 50%, rgba(201,162,39,0.28), rgba(124,77,255,0.12), transparent 70%);
                box-shadow: 0 0 18px rgba(77,208,225,0.15);
                filter: blur(3px);
                pointer-events: none;
                z-index: 2;
                opacity: 0;
            ...
            #tm-mascot-container.tm-aether-domain-on .tm-aether-domain-circle {
                animation: tm-aether-domain-seal 2.8s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            @keyframes tm-aether-domain-seal {
                0% { opacity: 0; transform: scale(0.55); }
                30% { opacity: 0.85; transform: scale(1.05); }
                100% { opacity: 0.4; transform: scale(1); }
            }

            /* Daily eclipse — mascot-local only */
            #tm-aether-eclipse-event,
            .tm-aether-eclipse-event-local {
                position: absolute;
                inset: -30%;
                pointer-events: none;
                z-index: 6;
                opacity: 0;
                background: radial-gradient(ellipse at 50% 30%, rgba(5,1,12,0.35), transparent 70%);
                animation: tm-aether-eclipse-sky 4s cubic-bezier(0.4, 0, 0.6, 1) forwards;
            }
            .tm-aether-eclipse-crescent-pass {
                position: absolute;
                left: -10%;
                top: 28%;
                width: 48px; height: 48px;
                border-radius: 50%;
                background: radial-gradient(circle at 35% 40%, rgba(201,162,39,0.55), rgba(5,1,12,0.9) 58%);
                animation: tm-aether-crescent-pass 4s cubic-bezier(0.45, 0.05, 0.55, 0.95) forwards;
            }
            @keyframes tm-aether-eclipse-sky {
                0% { opacity: 0; }
                15% { opacity: 1; }
                75% { opacity: 0.85; }
                100% { opacity: 0; }
            }
            @keyframes tm-aether-crescent-pass {
                0% { transform: translateX(0) scale(0.8); opacity: 0; }
                20% { opacity: 1; }
                100% { transform: translateX(160%) scale(1.1); opacity: 0.4; }
            }
            ...
            .tm-aether-nameplate {
                ...
                text-shadow: 0 0 8px rgba(124,77,255,0.55);
                opacity: 0;
                animation: tm-aether-nameplate-drip 3.2s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            .tm-aether-nameplate::before {
                content: '';
                position: absolute;
                left: 50%; top: -8px;
            ...
            @keyframes tm-aether-nameplate-drip {
            ...
            /* Mythic rarity edge chrome */
            #tm-mascot-container.mascot-char-aether.tm-aether-mythic-frame::before {
                /* keep glow, add chrome ring via box-shadow boost */
            }
            #tm-mascot-container.mascot-char-aether.tm-aether-mythic-shimmer {
                outline: 1px solid transparent;
            }
            #tm-mascot-container.mascot-char-aether.tm-aether-mythic-shimmer .tm-mascot-robot.mascot-char-aether {
                filter:
                    drop-shadow(0 0 1px rgba(255,255,255,0.7))
                    drop-shadow(0 0 6px rgba(201,162,39,0.45))
                    drop-shadow(0 0 14px rgba(124,77,255,0.35))
                    drop-shadow(0 8px 16px rgba(18,0,31,0.18)) !important;
                animation: tm-aether-rarity-chrome 2.4s cubic-bezier(0.45, 0.05, 0.55, 0.95) forwards !important;
            }
            @keyframes tm-aether-rarity-chrome {
                0%, 100% { filter:
                    drop-shadow(0 0 1px rgba(255,255,255,0.2))
                    drop-shadow(0 0 4px rgba(201,162,39,0.2))
            ...
            .tm-aether-moonshard-orbit {
                ...
                pointer-events: none;
                z-index: 5;
                animation: tm-aether-moon-spin 22s linear infinite;
            }
            .tm-aether-moonshard {
                position: absolute;
                left: 0; top: 0;
                ...
                border-radius: 50%;
                background: radial-gradient(circle, rgba(232,224,240,0.55), rgba(201,162,39,0.25), transparent 70%);
            ...
            .tm-aether-charge-ring::before {
                ...
                border-radius: 50%;
                border: none;
                background: radial-gradient(circle, rgba(232,224,240,0.18), transparent 65%);
                opacity: 0;
                filter: blur(4px);
            }
            ...
            #tm-mascot-container.tm-aether-awaken .tm-aether-charge-ring::before {
                opacity: 1;
                animation: tm-mythic-aura-pulse 2.8s ease-in-out infinite;
            }
            ...
            .tm-aether-apotheosis-local {
                ...
                background:
                    ...
                    radial-gradient(ellipse at 50% 80%, rgba(18,0,31,0.35), transparent 60%);
            ...
            /* Mythic border tiers — soft glow only (no rectangular dual outline) */
            ...
            #tm-mascot-container.mascot-char-aether.tm-aether-border-t3 .tm-mascot-robot {
                filter:
                    drop-shadow(0 8px 16px rgba(18,0,31,0.18))
                    drop-shadow(0 0 14px rgba(201,162,39,0.12));
            }
            #tm-mascot-container.mascot-char-aether.tm-aether-border-t4 .tm-mascot-robot {
                filter:
                    drop-shadow(0 8px 16px rgba(18,0,31,0.18))
                    drop-shadow(0 0 16px rgba(124,77,255,0.14))
                    drop-shadow(0 0 10px rgba(201,162,39,0.1));
            }
            #tm-mascot-container.mascot-char-aether.tm-aether-border-t5 .tm-mascot-robot {
                filter:
                    drop-shadow(0 8px 16px rgba(18,0,31,0.18))
                    drop-shadow(0 0 16px rgba(198,40,40,0.14))
                    drop-shadow(0 0 12px rgba(201,162,39,0.1));
            }
            #tm-mascot-container.mascot-char-aether.tm-aether-border-t6 .tm-mascot-robot {
                filter:
                    drop-shadow(0 8px 16px rgba(18,0,31,0.2))
                    drop-shadow(0 0 18px rgba(122,0,0,0.16))
                    drop-shadow(0 0 10px rgba(201,184,150,0.1));
            }
            ...
            /* --- Feature: Shop --- */
            #tm-shop-modal.tm-modal-overlay {
                z-index: 2147483600;
        ...
        `;
        tmAddStyleChunks(css);

        // Shop + interaction panel live near the end of the mega-sheet. Re-inject
        // them last so a truncated/aborted earlier chunk cannot leave the shop unstyled.
        const criticalStart = css.indexOf('/* Mascot Interaction Panel */');
        const shopStart = css.indexOf('/* --- Feature: Shop --- */');
        if (criticalStart >= 0) {
